...
3. Design and create API for the Android app  
     - Design API  
        ...
        ![api](https://github.com/heriirianto/Capstone-Project-Bangkit2022/blob/main/CC/readme_CC_assets/API%20Design.png)
       
     - Create API  
        Here is the endpoints on the API what we built:  
...
4. Configure Firebase Authentication System to be use on the app  
    ...
    ![database](https://github.com/heriirianto/Capstone-Project-Bangkit2022/blob/main/CC/readme_CC_assets/firebase%20authentication%20details.png)  
...
5. Create, config, and manage Compute Instance and Cloud Database Storage  
    ...
    Cloud SQL Storages Instance created, now it is the time to fill it with our previously Database Design on step 2 with this [.sql](https://github.com/heriirianto/Capstone-Project-Bangkit2022/blob/main/CC/DB_CREATE.sql)  MySQL-language-written queries. We could run it directly into our Cloud SQL by accessing it via GCP console or GCP terminal interfaces. In this way we dont have to wait for our GCE Compute Instance to be connected with the Storage Instance in order to work on the database.
